		...
		var doMove = function (){
				...
				$covers.each(function (i, e){
					...
					if( i < activeIndex ){
						...
						if(i+1==activeIndex){
							this.className = "immediate1 cbImage inactiveLeft inactiveLeft" + (activeIndex - i);
						}
						else{
							this.className = "cbImage inactiveLeft inactiveLeft" + (activeIndex - i) ;
						}
						...
						if(i-1==activeIndex){
							this.className = "immediate2 cbImage inactiveRight inactiveRight" + ((activeIndex - i)*-1);
						}
						else{
							this.className = "cbImage inactiveRight inactiveRight" + ((activeIndex - i)*-1) ;
						}
        ...
        var $covers = $(".cbImage"),
            ...
            generateClasses = function(){
                ...
                for(x=0; x<=l; x++){
                    ...
                    leftfac = al - (((self.state.coverDim.x * x)/2)-93) -  (self.state.coverDim.x/2);
                    rightfac = al + (((self.state.coverDim.x * x)/2)+8) + (self.state.coverDim.x/2);
